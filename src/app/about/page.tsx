    ...
    <>
      ...
      <SectionContainer className="py-8 sm:py-10 md:py-12">
        <div className="grid gap-12 sm:gap-16">
          <section>
            <h2 className="text-center font-bold tracking-tight mb-6">About the Author</h2>
          ...
          <section>
            <h2 className="text-center font-bold tracking-tight mb-6">Website Concept</h2>
            <div className="space-y-4">
              <p className="text-muted-foreground leading-relaxed">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8 md:mt-10">
                <div className="bg-card/60 border border-primary/20 p-4 sm:p-6 rounded-lg shadow-sm">
                  <h3 className="font-medium mb-2">Performance First</h3>
                ...
                <div className="bg-card/60 border border-primary/20 p-4 sm:p-6 rounded-lg shadow-sm">
                  <h3 className="font-medium mb-2">Modern Design</h3>
                  <p className="text-muted-foreground">
